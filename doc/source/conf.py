...
sys.path.append(os.path.abspath('../../hsl/ordering'))
...
try:
    from hsl import version as __version__
    # The short X.Y version.
...
latex_documents = [
  ('contents', 'user_manual.tex', ur"HSL.py's users manual",
