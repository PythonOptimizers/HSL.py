...
def coord2csc(ncol, irow, jcol, val=None):
    """Convert a sparse matrix in triple format into CSC format.

    To convert to compressed sparse row (csr) format, substitute
...
def csc2coord(rowind, colptr):
    """Convert a sparse matrix in CSC format into triple format.
