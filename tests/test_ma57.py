...
import pytest
try:
    from hsl.solvers.pyma57 import PyMa57Solver
except ImportError:
    pass
...
def ma57_spec_sheet():
    """This is the example from the MA57 spec sheet.
...
class Test_MA57(TestCase):

    def setUp(self):
        pytest.importorskip("hsl.solvers._pyma57")

    def test_init(self):
        # Solve example from the spec sheet
        (A, rhs) = ma57_spec_sheet()
        sils = PyMa57Solver(A)
    ...
    #     (A_sp, rhs) = ma57_spec_sheet()
    #     sils = PyMa57Solver(A_sp)
